...
- 主题回响：在高潮与结局处回环母题/意象；明确“主角代价与成长”对应的核心命题。
...
## 标题增强原则（不改变输出格式）
- 核心策略：以主角特征/世界设定/核心冲突/情感共鸣四选一为核心轴心。
...
```
# 段落
结尾章节的内容。如果是最终章，必须以"（全文完）"结尾；如非最终章，则需形成阶段性高潮后的短收束与明确过渡。
# 计划
...
```
# 润色结果
多段话，不需要标题，不少于3000字。如果是最终章，必须以"（全文完）"结尾
# END
```
