# -*- coding: utf-8 -*-
"""
开头生成器提示词 - zhihu 风格 - 精简模式
自动生成，风格配置复用自 writer_prompt_zhihu.py
"""

from prompts.compact.writer_prompt_zhihu import STYLE_CONFIG

from prompts.compact.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_compact_zhihu_prompt = BEGINNING_BASE_TEMPLATE.format(
