# -*- coding: utf-8 -*-
"""
开头生成器提示词 - ertong_huiben 风格 - 精简模式
自动生成，风格配置复用自 writer_prompt_ertong_huiben.py
"""

from prompts.compact.writer_prompt_ertong_huiben import STYLE_CONFIG

from prompts.compact.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_compact_ertong_huiben_prompt = BEGINNING_BASE_TEMPLATE.format(
