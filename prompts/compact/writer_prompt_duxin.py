# -*- coding: utf-8 -*-
"""
正文生成器提示词 - 读心术文风格 (风格特定配置)
"""

STYLE_CONFIG = {
    "role": "你是一位专精读心术文的畅销小说作家,已经出版过多部深受读者喜爱的读心术文作品。",
    "goals": "依据输入在当前章节继续写作,保持读心术文的风格特色与连贯性。",
    "style_characteristics": "", "style_skills": "", "style_constraints": "",
    "style_process": "", "style_attention": "", "style_writing_points": ""
}
...
novel_writer_duxin_prompt = WRITER_BASE_TEMPLATE.format(
    ROLE=STYLE_CONFIG["role"], GOALS=STYLE_CONFIG["goals"],
