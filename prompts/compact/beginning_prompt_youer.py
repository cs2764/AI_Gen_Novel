# -*- coding: utf-8 -*-
"""
开头生成器提示词 - youer 风格 - 精简模式
自动生成，风格配置复用自 writer_prompt_youer.py
"""

from prompts.compact.writer_prompt_youer import STYLE_CONFIG

from prompts.compact.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_compact_youer_prompt = BEGINNING_BASE_TEMPLATE.format(
