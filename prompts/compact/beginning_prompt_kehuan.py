# -*- coding: utf-8 -*-
"""
开头生成器提示词 - kehuan 风格 - 精简模式
自动生成，风格配置复用自 writer_prompt_kehuan.py
"""

from prompts.compact.writer_prompt_kehuan import STYLE_CONFIG

from prompts.compact.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_compact_kehuan_prompt = BEGINNING_BASE_TEMPLATE.format(
