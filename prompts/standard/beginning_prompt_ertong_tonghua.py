# -*- coding: utf-8 -*-
"""
开头生成器提示词 - ertong_tonghua 风格 - 标准模式
自动生成，风格配置复用自 writer_prompt_ertong_tonghua.py
"""

from prompts.standard.writer_prompt_ertong_tonghua import STYLE_CONFIG

from prompts.standard.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_ertong_tonghua_prompt = BEGINNING_BASE_TEMPLATE.format(
