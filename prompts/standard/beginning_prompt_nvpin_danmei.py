# -*- coding: utf-8 -*-
"""
开头生成器提示词 - nvpin_danmei 风格 - 标准模式
自动生成，风格配置复用自 writer_prompt_nvpin_danmei.py
"""

from prompts.standard.writer_prompt_nvpin_danmei import STYLE_CONFIG

from prompts.standard.base_beginning_template import BEGINNING_BASE_TEMPLATE

novel_beginning_nvpin_danmei_prompt = BEGINNING_BASE_TEMPLATE.format(
