...
## Workflows:
必须为每章生成4个plot_segments分段规划，各段衔接但不重叠。
...
- **质量标准**：plot_summary包含（目标→冲突→行动→结果→影响），key_events可执行或信息揭示，transition_to_next具体承接，plot_purpose说明推进作用，emotional_tone给出基调关键词
